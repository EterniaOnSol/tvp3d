...
func _probar() -> void:
	...
	for tipo in [21,34,39,56,30,36,38,208,219,27,52,3,16,42,123,28,81,26,82,83,79,43,45,124]:
	...
	for tipo_arana in [30,36,38,208,219,27,52,3,16,42,123,28,81,26,82,83,79,43,45,124]:
