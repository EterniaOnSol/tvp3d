...
class Player final : public Creature, public Cylinder
{
	public:
		...
		void sendCreatureSay(uint32_t statementId, const Creature* creature, SpeakClasses type, const std::string& text, const Position* pos = nullptr) {
			if (client) {
		...
		void sendToChannel(uint32_t statementId, const Creature* creature, SpeakClasses type, const std::string& text, uint16_t channelId) const {
			if (client) {
